...
class Beca
{
    ...
    function create()
    {
        $query = "INSERT INTO " . $this->table_name . " (nombre, descripcion, archivo, activo) VALUES (:nombre, :descripcion, :archivo, :activo)";
    ...
    function read()
    {
        $query = "SELECT id, nombre, descripcion, archivo, activo, fecha_creacion FROM " . $this->table_name . " ORDER BY fecha_creacion DESC";
        $stmt = $this->conn->prepare($query);
        $stmt->execute();
        return $stmt;
    }
    ...
    function update()
    {
        ...
        $query = "UPDATE " . $this->table_name . " SET nombre = :nombre, descripcion = :descripcion, archivo = :archivo, activo = :activo WHERE id = :id";
        $stmt = $this->conn->prepare($query);
