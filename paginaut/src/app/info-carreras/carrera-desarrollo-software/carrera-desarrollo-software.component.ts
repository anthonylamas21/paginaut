...
export class CarreraDesarrolloSoftwareComponent {
  ...
  images: Image[] = [
    ...
    { url: './assets/img/galeria/desarrollo/TIC_18.jpg', alt: '' },
    { url: './assets/img/galeria/desarrollo/TIC_19.jpg', alt: '' },
    { url: './assets/img/galeria/desarrollo/TIC_20.jpg', alt: '' },
    { url: './assets/img/galeria/desarrollo/TIC_21.jpg', alt: '' },
    { url: './assets/img/galeria/desarrollo/TIC_25.jpg', alt: '' },
    { url: './assets/img/galeria/desarrollo/TIC_26.jpeg', alt: '' },
    { url: './assets/img/galeria/desarrollo/TIC_27.jpg', alt: '' },
    { url: './assets/img/galeria/desarrollo/TIC_29.jpeg', alt: '' },
    { url: './assets/img/galeria/desarrollo/TIC_32.jpeg', alt: '' },
    ...
    { url: './assets/img/galeria/desarrollo/TIC_36.jpeg', alt: '' },
