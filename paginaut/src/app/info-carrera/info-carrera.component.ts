...
export class InfoCarreraComponent {
  ...
  items: Item[] = [
    ...
    {uno: 'Inglés I',  dos: 'Inglés II',  tres: 'Inglés III',  cuatro: 'Inglés IV',  cinco: 'Inglés V',  seis: 'Estadia',  siete: 'Administración del tiempo',  ocho: '',  nueve: '',  diez: 'Inglés IX',  once: 'Estadia'},
